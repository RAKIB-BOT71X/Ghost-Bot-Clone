...
module.exports = {
  config: {
    name: "hack5",
    aliases: ["ghosthack5", "cyberhack5"],
    version: "1.0", author: "Rakib Islam",
    countDown: 10, role: 0,
    shortDescription: "Fake hack animation v5 - fun only!",
  ...
  onStart: async function ({ api, event, message, usersData }) {
    ...
    const step1 = "Hack v5: Target: " + targetName + "\nScanning...";
    const step2 = "Hack v5: " + targetName + "\nIP: " + ip + "\nDevice: " + device + "\nBypassing...";
    const step3 = "Hack v5: ACCESS GRANTED!\nTarget: " + targetName + "\nIP: " + ip + "\nDevice: " + device + "\n\nJUST FOR FUN! Ghost Net";
    ...
    try {
      ...
      await api.sendMessage({ body: "Hack Complete! Ghost Net v5", attachment: st }, threadID);
    } catch {}
  }
};