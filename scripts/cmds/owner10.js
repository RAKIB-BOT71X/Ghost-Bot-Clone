...
const idx = 10 % FRAMES.length;
module.exports = {
  config: {
    name: "owner10",
    aliases: ["ownerinfo10", "oinfo10"],
    version: "1.0", author: "Rakib Islam",
    countDown: 5, role: 0,
    shortDescription: "Owner profile card #10 with unique GIF",
  ...
  onStart: async function ({ message, event }) {
    ...
    const body =
      ...
      ico + " ━━━━━━━━━━━━━━━━━━━━━━ " + ico + "\n" +
      "  Ghost Net — Variant #10";
    const gif = GIFS[10 % GIFS.length];
    try {
