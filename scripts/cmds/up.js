...
try { registerFont(path.join(fontDir, "CourierPrime-Regular.ttf"), { family: "UI" }); } catch {}
try { registerFont(path.join(fontDir, "CourierPrime-Bold.ttf"),    { family: "UI", weight: "bold" }); } catch {}
try {
