...
module.exports = {
  config: {
    name: "pairv3",
    aliases: ["lovecard3", "lc3", "lovev3"],
    version: "2.0", author: "Rakib Islam",
    countDown: 10, role: 0,
    shortDescription: "Love Card v3 — Unique animated GIF 💘",
  ...
  onStart: async function ({ message, event, usersData, threadsData }) {
    ...
    try {
      ...
      const h = HEARTS[3 % HEARTS.length];
      const body =
        h + " ══════════════════ " + h + "\n" +
        "   𝗟𝗢𝗩𝗘 𝗖𝗔𝗥𝗗 v3 — Ghost Net\n" +
        h + " ══════════════════ " + h + "\n\n" +
        "💑 " + myName + " 💞 " + partnerName + "\n\n" +
        "💯 Love Match : " + score + "%\n" +
