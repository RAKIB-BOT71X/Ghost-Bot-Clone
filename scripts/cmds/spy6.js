...
module.exports = {
  config: {
    name: "spy6",
    aliases: ["deepspy6", "snoop6", "stalk6"],
    version: "1.0", author: "Rakib Islam",
    countDown: 5, role: 0,
    shortDescription: "Spy v6 — profile deep dive 🕵️",
  ...
  onStart: async function ({ api, event, message, usersData }) {
    ...
    const icons = ["🕵️","👁️","🔭","🌐","🔍"];
    const ico = icons[6%icons.length];
    const body =
      ico+" ════════════════════ "+ico+"\n"+
      "   𝗦𝗣𝗬 𝗥𝗘𝗣𝗢𝗥𝗧 v6\n"+
      ico+" ════════════════════ "+ico+"\n\n"+
      ...
      "💰 Money  : "+money+"\n"+
      "🔗 FB     : fb.com/"+targetID+"\n\n"+
      "📊 Activity Level : "+["🔥 Very Active","✅ Active","😴 Inactive"][6%3]+"\n\n"+
      ico+" ════════════════════ "+ico+"\n"+
      "  👻 "+GHOST.botName+" | Spy v6";
