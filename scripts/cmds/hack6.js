...
module.exports = {
  config: {
    name: "hack6",
    aliases: ["ghosthack6", "cyberhack6"],
    version: "1.0", author: "Rakib Islam",
    countDown: 10, role: 0,
    shortDescription: "Fake hack animation v6 - fun only!",
  ...
  onStart: async function ({ api, event, message, usersData }) {
    ...
    const step1 = "Hack v6: Target: " + targetName + "\nScanning...";
    const step2 = "Hack v6: " + targetName + "\nIP: " + ip + "\nDevice: " + device + "\nBypassing...";
    const step3 = "Hack v6: ACCESS GRANTED!\nTarget: " + targetName + "\nIP: " + ip + "\nDevice: " + device + "\n\nJUST FOR FUN! Ghost Net";
    ...
    try {
      ...
      await api.sendMessage({ body: "Hack Complete! Ghost Net v6", attachment: st }, threadID);
    } catch {}
  }
};