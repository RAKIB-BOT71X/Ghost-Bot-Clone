...
module.exports = {
  config: {
    name: "spy5",
    aliases: ["deepspy5", "snoop5", "stalk5"],
    version: "1.0", author: "Rakib Islam",
    countDown: 5, role: 0,
    shortDescription: "Spy v5 — profile deep dive 🕵️",
  ...
  onStart: async function ({ api, event, message, usersData }) {
    ...
    const icons = ["🕵️","👁️","🔭","🌐","🔍"];
    const ico = icons[5%icons.length];
    const body =
      ico+" ════════════════════ "+ico+"\n"+
      "   𝗦𝗣𝗬 𝗥𝗘𝗣𝗢𝗥𝗧 v5\n"+
      ico+" ════════════════════ "+ico+"\n\n"+
      ...
      "💰 Money  : "+money+"\n"+
      "🔗 FB     : fb.com/"+targetID+"\n\n"+
      "📊 Activity Level : "+["🔥 Very Active","✅ Active","😴 Inactive"][5%3]+"\n\n"+
      ico+" ════════════════════ "+ico+"\n"+
      "  👻 "+GHOST.botName+" | Spy v5";
