...
module.exports = {
  config: {
    name: "spy4",
    aliases: ["deepspy4", "snoop4", "stalk4"],
    version: "1.0", author: "Rakib Islam",
    countDown: 5, role: 0,
    shortDescription: "Spy v4 — profile deep dive 🕵️",
  ...
  onStart: async function ({ api, event, message, usersData }) {
    ...
    const icons = ["🕵️","👁️","🔭","🌐","🔍"];
    const ico = icons[4%icons.length];
    const body =
      ico+" ════════════════════ "+ico+"\n"+
      "   𝗦𝗣𝗬 𝗥𝗘𝗣𝗢𝗥𝗧 v4\n"+
      ico+" ════════════════════ "+ico+"\n\n"+
      ...
      "💰 Money  : "+money+"\n"+
      "🔗 FB     : fb.com/"+targetID+"\n\n"+
      "📊 Activity Level : "+["🔥 Very Active","✅ Active","😴 Inactive"][4%3]+"\n\n"+
      ico+" ════════════════════ "+ico+"\n"+
      "  👻 "+GHOST.botName+" | Spy v4";
